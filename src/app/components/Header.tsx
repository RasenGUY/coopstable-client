  ...
  return (
    <header data-testid="header">
      <div className={cn(pageWrapClasses, "pt-5 lg:pt-10 flex items-center")}>
        ...
        <Link target="_blank" href="https://form.typeform.com/to/sHp99h2H" className="hidden lg:inline mx-1 font-theme-2 px-6 py-3 text-[20px] lg:text-xl text-theme-black bg-theme-grey-3 font-bold uppercase hover:cursor-pointer">Sumbit Project</Link> 
        <Account />
      </div>
    </header>
  );
